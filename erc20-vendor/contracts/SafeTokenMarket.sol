...
import "./SafeTokenV2.sol";

import "@openzeppelin/contracts/access/Ownable.sol";

contract SafeTokenMarket is Ownable {
    // Our Token Contract
    SafeTokenV2 safeToken;
    ...
    constructor(address tokenAddress) {
        safeToken = SafeTokenV2(tokenAddress);
    }
    ...
    function buyTokens() public payable returns (uint256 tokenAmount) {
        ...
        uint256 vendorBalance = safeToken.balanceOf(address(this));
        require(
        ...
        bool sent = safeToken.transfer(msg.sender, amountToBuy);
    ...
    function sellTokens(uint256 tokenAmountToSell) public {
        ...
        uint256 userBalance = safeToken.balanceOf(msg.sender);
        require(
        ...
        bool sent = safeToken.transferFrom(
            msg.sender,
            address(this),
            tokenAmountToSell
        );
